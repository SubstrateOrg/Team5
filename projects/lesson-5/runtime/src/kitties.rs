...
decl_module! {
	pub struct Module<T: Trait> for enum Call where origin: T::Origin {
		...
		pub fn transfer(origin, to: T::AccountId, kitty_id: T::KittyIndex){
			let sender = ensure_signed(origin)?;
			// TODO-001
//			ensure!(<OwnedKitties<T>>::get((sender.clone(),kitty_id)) != Option<KittyLinkedItem{None,None}>,"kitty_id is not owned by the sender");
...
/////
/////给⾃己的小猫设定价钱
/////pub fn set_price(origin, kitty_id: T::KittyIndex,price: i32)
/////购买⼩猫
