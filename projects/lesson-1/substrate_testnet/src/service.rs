...
use futures::prelude::*;
use project1_substrate_testnet_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi, WASM_BINARY};
...
native_executor_instance!(
	pub Executor,
	project1_substrate_testnet_runtime::api::dispatch,
	project1_substrate_testnet_runtime::native_version
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			project1_substrate_testnet_runtime::opaque::Block, project1_substrate_testnet_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, transaction_pool| {
				...
				let (block_import, link_half) =
					grandpa::block_import::<_, _, _, project1_substrate_testnet_runtime::RuntimeApi, _, _>(
